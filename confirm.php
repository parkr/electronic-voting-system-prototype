        ...
        <div class="row">
          <div class="span11 offset2">
            <h2>Here are your votes, listed per position:</h2>
						<ul>
							<li>United States President:
								<ul>
									<li>Barack Obama <small><a href="presidential.php">(change)</a></small></li>
								</ul>
							</li>
							<li>22nd U.S. Congressional District Representative:
								<ul>
									<li>Maurice Hinchey <small><a href="congressional.php">(change)</a></small></li>
								</ul>
							</li>
							<li>Ithaca, NY Mayor:
								<ul>
